...
export default function DashboardPage() {
  ...
  return (
    <section className="col-span-12 grid grid-cols-12 gap-2 p-2 lg:p-4">
      <section className="col-span-12 flex flex-col rounded border border-light-500 bg-light-200 dark:border-base-700 dark:bg-base-800 lg:col-span-6 lg:row-span-2">
        <h3 className="flex w-full items-center justify-center border-b border-light-500 p-2 text-xl dark:border-base-700">
          Recent Activity
        </h3>

        <div className="mx-4 mb-2 mt-4 flex-1 border-spacing-7 flex-col items-center justify-center rounded border-2 border-dashed p-2 dark:border-base-700"></div>
        <Link
          href="/today"
