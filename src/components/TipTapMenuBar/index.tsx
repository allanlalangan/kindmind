        ...
        <button
          ...
          className={`h-8 w-8 rounded border p-1 transition ${
            editor.isActive("bold")
              ? "border-base-950 bg-light-100 text-base-950 dark:border-base-50 dark:bg-base-700 dark:text-base-50"
              : "border-light-500 text-base-950/25 hover:bg-light-100 dark:border-base-600 dark:text-base-50/25 hover:dark:bg-base-700"
          }`}
        >
        ...
        {/* <button
          ...
          className={`h-8 w-8 rounded border p-1 transition ${
            editor.isActive("paragraph")
              ? "dark:bg-base-700 bg-light-100 border-base-950 text-base-950 dark:border-base-50 dark:text-base-50"
              : "border-light-500 text-base-950/25 hover:bg-light-100 dark:border-base-600 dark:text-base-50/25 hover:dark:bg-base-700"
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
