  ...
  return (
    <>
      <div className="grid h-screen grid-cols-12 grid-rows-24">
        <header className="col-span-12 flex h-full items-center justify-between border-b border-light-500 bg-light-300 px-4 transition dark:border-b dark:border-base-800 dark:bg-base-900 lg:col-start-3 lg:col-end-13 lg:justify-end">
          <button
        ...
        <aside
          ...
          } fixed z-10 row-span-full row-start-1 h-screen w-1/2 bg-light-400 px-4 py-2 transition dark:bg-base-950 md:w-1/3 lg:static lg:col-start-1 lg:col-end-3 lg:w-full lg:-translate-x-0`}
        >
          <Link
